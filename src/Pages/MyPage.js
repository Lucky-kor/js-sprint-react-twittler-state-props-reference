...
const MyPage = () => {
  ...
  useState(dummyTweets.filter((tweet) => tweet.username === 'parkhacker'));
  
  // const filteredTweets = dummyTweets.filter((tweet) => tweet.username === 'parkhacker'));
  // const [tweets, setTweets] = useState(filteredTweets);
      ...
      <div className="myInfo__container">
        <div className="myInfo__wrapper">
          <div className="myInfo__profile">
            <img src={tweets[0].picture} />
          </div>
          <div className="myInfo__detail">
            <p className="myInfo__detailName">
              {tweets[0].username} Profile
            </p>
            <p>28 팔로워 100 팔로잉</p>
          </div>
        </div>
